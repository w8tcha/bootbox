            ...
            describe('where the argument is an object', () => {
                beforeEach(function () {
                    ...
                    create = (function (_this) {
                        return function () {
                            return dialog = bootbox.prompt(options);
                        };
                    })(this);
                });
                ...
                describe('with a title property', () => {
                    beforeEach(function () {
                        return options.title = 'What is your name?';
                    });
                    ...
                    describe('and a callback property', () => {
                        describe('where the callback is not a function', () => {
                            beforeEach(function () {
                                return options.callback = 'Not a function';
                            });
                            it('throws an error requiring a callback', () => {
                                expect(() => bootbox.prompt('What is your name?')).toThrowError('prompt requires a callback');
                            });
        ...
        describe('with two arguments', () => {
            describe('where the second argument is not a function', () => {
                beforeEach(function () {
                    create = (function (_this) {
                        return function () {
                            return dialog = bootbox.prompt('What is your name?', 'callback here');
                        };
                    })(this);
                });
                it('throws an error requiring a callback', () => {
            ...
            describe('where the second argument is a function', () => {
                beforeEach(function () {
                    create = (function (_this) {
                        return function () {
                            return dialog = bootbox.prompt('What is your name?', () => {
                                return true;
                            });
                        };
                    })(this);
                ...
                it('with no default value', () => {
                    expect(dialog.querySelector('form input[type="text"]').value).to.equal('');
                });
                /*it('shows the dialog', () => {
    ...
    describe('configuration options tests', () => {
        ...
        describe('with `centerVertical` set to `true`', () => {
            ...
            it('adds the modal-dialog-centered class to the innerDialog of the prompt', () => {
                expect(dialog.querySelector(".modal-dialog").classList).toContain('modal-dialog-centered');
            });
        });
        ...
        describe('with `centerVertical` set to `false`', () => {
            ...
            it('does not add the modal-dialog-centered class to the innerDialog of the prompt', () => {
                expect(dialog.querySelector(".modal-dialog").classList).not.toContain('modal-dialog-centered');
            });
        });
        ...
        describe('invalid prompt type', () => {
            beforeEach(function () {
                return options.inputType = 'foobar';
            });
            it('throws an error', () => {
        ...
        describe('setting inputType text', () => {
            ...
            describe('without default value', () => {
                ...
                it('shows text input ', () => {
                    expect(exists('input[type="text"]')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="text"]').value).to.equal('John Smith');
                });
            });
        ...
        describe('setting inputType textarea', () => {
            beforeEach(function () {
                return options.inputType = 'textarea';
            });
            describe('without default value', () => {
                beforeEach(function () {
                    return create();
                ...
                it('shows text input', () => {
                    expect(exists('textarea')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('textarea').value).to.equal('Once upon a time...');
                });
            });
        ...
        describe('setting inputType email', () => {
            beforeEach(function () {
                return options.inputType = 'email';
            });
            describe('without default value', () => {
                beforeEach(function () {
                    return create();
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="email"]').value).to.equal('john@smith.com');
                });
            });
            describe('with placeholder', () => {
                beforeEach(function () {
        ...
        describe('setting inputType password', () => {
            beforeEach(function () {
                return options.inputType = 'password';
            });
            describe('without default value', () => {
                beforeEach(function () {
                    return create();
                ...
                it('shows password input', () => {
                    expect(exists('input[type="password"]')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="password"]').value).to.equal('qwerty');
                });
            });
            describe('with placeholder', () => {
                beforeEach(function () {
        ...
        describe('setting inputType select', () => {
            describe('without options', () => {
                beforeEach(function () {
                    return options.inputType = 'select';
                });
                it('throws an error', () => {
        ...
        describe('setting inputType checkbox', () => {
            describe('without options', () => {
                beforeEach(function () {
                    return options.inputType = 'checkbox';
                });
                it('throws an error', () => {
            ...
            describe('with options', () => {
                ...
                it('shows checkbox input', () => {
                    expect(exists('input[type="checkbox"]')).not.null;
                });
                it('has proper class', () => {
        ...
        describe('setting inputType radio', () => {
            describe('without options', () => {
                beforeEach(function () {
                    return options.inputType = 'radio';
                });
                it('throws an error', () => {
            ...
            describe('with options', () => {
                ...
                it('shows radio input', () => {
                    expect(exists('input[type="radio"]')).not.null;
                });
                it('has proper class', () => {
        ...
        describe('setting inputType date', () => {
            ...
            describe('without default value', () => {
                ...
                it('shows date input ', () => {
                    expect(exists('input[type="date"]')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="date"]').value).to.equal('2005-08-17');
                });
            });
            describe('with placeholder', () => {
                beforeEach(function () {
        ...
        describe('setting inputType time', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="time"]').value).to.equal('19:02');
                });
            });
            describe('with placeholder', () => {
                beforeEach(function () {
            ...
            /*describe('with min value greater than max value', () => {
                ...
                it('throws an error', () => {
                    expect(() => bootbox.prompt(options)).rejects.toThrowError('"max" must be greater than or equal to "min".');
                });
            });*/
        ...
        describe('setting inputType number', () => {
            ...
            describe('without default value', () => {
                ...
                it('shows number input ', () => {
                    expect(exists('input[type="number"]')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="number"]').value).to.equal('300');
                });
            });
            describe('with placeholder', () => {
                beforeEach(function () {
        ...
        describe('setting inputType range', () => {
            beforeEach(function () {
                return options.inputType = 'range';
            });
            ...
            describe('without default value', () => {
                ...
                it('shows range input ', () => {
                    expect(exists('input[type="range"]')).not.null;
                });
                it('has proper class', () => {
            ...
            describe('with default value', () => {
                ...
                it('has correct default value', () => {
                    expect(find('input[type="range"]').value).to.equal('50');
                });
            });
    ...
    describe('callback tests', () => {
        ...
        describe('with a simple callback', () => {
            ...
            describe('when entering no value in the text input', () => {
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-accept').click();
                    });
                ...
                describe('when submitting the form', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-form').dispatchEvent(new Event('submit'));
                    });
            ...
            describe('when entering a value in the text input', () => {
                beforeEach(function () {
                    return dialog.querySelector('.bootbox-input').value = 'Test input';
                });
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-accept').click();
            ...
            describe('when dismissing the dialog by clicking Cancel', () => {
                beforeEach(function () {
                    return dialog.querySelector('.bootbox-cancel').click();
                });
                it('should invoke the callback', () => {
                    expect(callback).toHaveBeenCalled();
                });
            ...
            describe('when dismissing the dialog by clicking the close button', () => {
                beforeEach(function () {
                    return dialog.querySelector('.close').click();
                });
                it('should invoke the callback', () => {
                    expect(callback).toHaveBeenCalled();
                });
        ...
        describe('with a default value', () => {
            ...
            it('populates the input with the default value', () => {
                expect(dialog.querySelector('.bootbox-input').value).to.equal('Bob');
            });
            describe('when entering no value in the text input', () => {
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(function () {
            ...
            describe('when entering a value in the text input', () => {
                beforeEach(function () {
                    return dialog.querySelector('.bootbox-input').value = 'Alice';
                });
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-accept').click();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                ...
                describe('when changing the selected option and dismissing the dialog by clicking OK', () => {
                    beforeEach(function () {
                        dialog.querySelector('.bootbox-input-select').value = 3;
                        return dialog.querySelector('.bootbox-accept').click();
                    });
                    it('should invoke the callback', () => {
                        expect(callback).toHaveBeenCalled();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                ...
                describe('when entering a value in the email input', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-input-email').value = 'john@smith.com';
                    });
                    describe('when dismissing the dialog by clicking OK', () => {
                        beforeEach(function () {
                            return dialog.querySelector('.bootbox-accept').click();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                ...
                describe('when changing a value in the email input', () => {
                    beforeEach(function () {
                        return dialog.querySelector('.bootbox-input-email').value = 'smith@john.com';
                    });
                    describe('when dismissing the dialog by clicking OK', () => {
                        beforeEach(function () {
                            return dialog.querySelector('.bootbox-accept').click();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                    ...
                    describe('when changing the checked option and dismissing the dialog by clicking Cancel', () => {
                        beforeEach(function () {
                            dialog.querySelector('input[type="checkbox"]:checked').checked = false;
                            dialog.querySelector('input[type="checkbox"][value="3"]').checked = true;
                            return dialog.querySelector('.bootbox-cancel').click();
                        });
                        it('should invoke the callback', () => {
                            expect(callback).toHaveBeenCalled();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                    ...
                    describe('when changing the checked options and dismissing the dialog by clicking Cancel', () => {
                        beforeEach(function () {
                            ...
                            dialog.querySelector('input[type="checkbox"][value="1"').checked = true;
                            dialog.querySelector('input[type="checkbox"][value="4"]').checked = true;
                            return dialog.querySelector('.bootbox-cancel').click();
                        });
                        it('should invoke the callback', () => {
                            expect(callback).toHaveBeenCalled();
        ...
        hidden = vi.spyOn(modalInstance, 'hide');
                    ...
                    describe('when changing the checked option and dismissing the dialog by clicking Cancel', () => {
                        beforeEach(function () {
                            dialog.querySelector('input[type="radio"][value="3"]').checked = true;
                            return dialog.querySelector('.bootbox-cancel').click();
                        });
                        it('should invoke the callback', () => {
                            expect(callback).toHaveBeenCalled();
