...
let button: HTMLElement | null;
 ...
 var find = selector => dialog.querySelector(selector);
        var text = selector => find(selector).textContent;
        var exists = selector => find(selector).length !== 0;
...
describe('bootbox.prompt', () => {
    ...
    describe('callback tests', () => {
        ...
        describe('with a simple callback', () => {
            ...
            describe('when entering no value in the text input', () => {
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(() => dialog.querySelector('.bootbox-accept').click());
            ...
            describe('when entering a value in the text input', () => {
                beforeEach(() => dialog.querySelector('.bootbox-input').value = 'Test input');
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(() => dialog.querySelector('.bootbox-accept').click());
                    it('should invoke the callback', () => {
                        expect(callback).toHaveBeenCalled();
            ...
            describe('when dismissing the dialog by clicking Cancel', () => {
                beforeEach(() => dialog.querySelector('.bootbox-cancel').click());
                it('should invoke the callback', () => {
                    expect(callback).toHaveBeenCalled();
                });
                it('should pass the dialog as "this"', () => {
            ...
            describe('when dismissing the dialog by clicking the close button', () => {
                beforeEach(() => dialog.querySelector('.close').click());
                it('should invoke the callback', () => {
                    expect(callback).toHaveBeenCalled();
                });
                it('should pass the dialog as "this"', () => {
        ...
        describe('with a default value', () => {
            ...
            describe('when entering a value in the text input', () => {
                beforeEach(() => dialog.querySelector('.bootbox-input').value = 'Alice');
                describe('when dismissing the dialog by clicking OK', () => {
                    beforeEach(() => dialog.querySelector('.bootbox-accept').click());
                    it('should invoke the callback', () => {
                        expect(callback).toHaveBeenCalled();
        ...
        describe('with inputType email', () => {
            describe('without a default value', () => {
                ...
                describe('when entering a value in the email input', () => {
                    beforeEach(() => dialog.querySelector('.bootbox-input-email').value = 'john@smith.com');
                    describe('when dismissing the dialog by clicking OK', () => {
                        beforeEach(() => dialog.querySelector('.bootbox-accept').click());
                        it('should invoke the callback', () => {
                            expect(callback).toHaveBeenCalled();
            ...
            describe('with a default value', () => {
                ...
                describe('when changing a value in the email input', () => {
                    beforeEach(() => dialog.querySelector('.bootbox-input-email').value = 'smith@john.com');
                    describe('when dismissing the dialog by clicking OK', () => {
                        beforeEach(() => dialog.querySelector('.bootbox-accept').click());
                        it('should invoke the callback', () => {
                            expect(callback).toHaveBeenCalled();
