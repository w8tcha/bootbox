...
describe('Bootbox', () => {
    ...
    describe('hidden.bs.modal', () => {
      beforeEach(() => {
        ...
        e = function(target) {
         ...
         dialog?.dispatchEvent(new CustomEvent('hidden.bs.modal', {detail: {target: target}}));
        };
      });
    ...
    describe('bootbox.addLocale', () => {
      describe('with invalid values', () => {
        it('throws the expected error', () => {
          expect(() => bootbox.addLocale('xy', {OK: 'BTN1'})).toThrowError('Please supply a translation for "CANCEL"');
        });
      });
  ...
  describe('resuable not set dialog', () => {
    describe('hidden.bs.modal', () => {
      beforeEach(() => {
