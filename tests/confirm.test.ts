...
describe('bootbox.confirm', () => {
  ...
  describe('basic usage tests', () => {
    describe('with one argument', () => {
      ...
      describe('where the argument is not an object', () => {
        it('throws an error', () => {
          expect(() => bootbox.confirm('Are you sure?')).toThrowError(/confirm requires a callback/);
        });
      });
      ...
      describe('where the argument is an object', () => {
        ...
        describe('with a message property', () => {
          ...
          it('throws an error requiring a callback', () => {
            expect(() => bootbox.confirm('Are you sure?', options)).toThrowError(/confirm requires a callback/);
          });
        });
          ...
          describe('where the callback is a function', () => {
            beforeEach(() => {
             ...
             it('throws an error requiring a message', () => {
              expect(() => bootbox.confirm(options)).toThrowError(/"message" option must not be null or an empty string./);
            });
          });
        });
    ...
    describe('with two arguments', () => {
      describe('where the second argument is not a function', () => {
        it('throws an error requiring a callback', () => {
          expect(() => bootbox.confirm('Are you sure?', 'callback here')).toThrowError(/confirm requires a callback/);
        });
      });
      ...
      describe('where the second argument is a function', () => {
        ...
        it('adds the correct button labels', () => {
          expect(dialog?.querySelector<HTMLElement>('.btn:first-child')?.textContent).to.equal('Cancel');
          expect(dialog?.querySelector<HTMLElement>('.btn:last-child')?.textContent).to.equal('OK');
        });
        it('adds the correct button classes', () => {
  ...
  describe('configuration options tests', () => {
    ...
    describe('with an unrecognised button key', () => {
      ...
      it('throws an error', () => {
        expect(() => bootbox.confirm(options)).toThrowError('button key "Bad key" is not allowed (options are cancel confirm)');
      });
    });
  });
