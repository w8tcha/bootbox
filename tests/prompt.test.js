        ...
        describe('setting inputType range', function () {
            ...
            describe('with min and max value', function () {
                ...
                return it('has correct min and max values', function () {
                    return expect(this.find('input[type="range"]').getAttribute('min')).to.equal('10') && expect(this.find('input[type="range"]').getAttribute('max')).to.equal('100');
                });
            });
            ...
            describe('with min and max value equal', function () {
                ...
                return it('has correct min and max values', function () {
                    return expect(this.find('input[type="range"]').getAttribute('min')).to.equal('10') && expect(this.find('input[type="range"]').getAttribute('max')).to.equal('10');
                });
            });
